    ...
    def _solve_equation(self,
        ...
        for missing_variable in MAPPER:
            ...
            for solution in solutions:
                ...
                column_values = [(self.table.loc[indices][var] * UNIT_MAPPER[key].value) for key, var in other_variables.items()]
                column_values_results.append(func(*column_values) / UNIT_MAPPER[missing_variable].value)
                uncertainties = [symbols(f"sigma_{variable}") for key, variable in other_variables.items()]
                ...
                uncertainty_results.append(uncertainty_result / UNIT_MAPPER[missing_variable].value)
